  ...
  return (
    <div className="mainsticky mt-4">
      ...
      <div className="compact-links2 mt-1 d-flex justify-content-center">
        ...
        <a
          className="items choices"
          href="https://www.linkedin.com/help/linkedin/answer/62931?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3BIvDJ8flGSJG7%2BUFMDZeaBw%3D%3D">
          Ad Choices
        </a>
      </div>
      <div className="compact-links3 d-flex justify-content-center">
        <a
          className=" mx-2 items adv"
        ...
        <DropdownButton
          ...
          <Dropdown.Item
            ...
            Talent Solutions{" "}
            <div className="text-muted drop2sub ">
          ...
          <Dropdown.Item
            ...
            Post a job for free{" "}
            <div className="text-muted drop2sub ">
              <br /> Get your job in front of quality <br /> Candidates
            </div>
          </Dropdown.Item>
          <Dropdown.Item
            href="https://business.linkedin.com/it-it/marketing-solutions/ads?lr=1"
            ...
            Marketing Solutions{" "}
            <div className="text-muted drop2sub ">
              <br /> develop talent across your <br /> organization
            </div>
          </Dropdown.Item>
          <Dropdown.Item
      ...
      <div className="compact-links4 d-flex justify-content-center">
        <Button size="small" className="buttonsModal">
          Get the Linkedin app
        </Button>
        <Button size="small" className="buttonsModal ml-3">
          More
        </Button>
      </div>
